...
export const getDate = () => {
    ...
    const opcoesFormato = { timeZone: fusoHorarioBrasilia };
  
    // Obter a data atual no fuso horário de Brasília
    const dataFusoHorario = dataAtual.toLocaleDateString("pt-BR", opcoesFormato);
    const formatedDate = dataFusoHorario.split('/').join('')
